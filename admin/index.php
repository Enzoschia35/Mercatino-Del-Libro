<?php
    $page = isset($_GET["page"]) ? $_GET["page"] : 'dashboard'; //reindirizzo le pagine dinamicamente tramite la query string
...
<div id="main"class="container" style="margin-top: 50px;">
    <div class="row">
        ...
        <div class="col-12">
            <?php include  ROOT_PATH . 'admin/pagine/' . $page . '.php'?> <!-- Riduco il codice utilizzando il risultato della query string-->
        </div>
