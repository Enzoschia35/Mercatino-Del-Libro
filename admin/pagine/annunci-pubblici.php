...
<div class="container">
        <div class="mb-4">
            <h2 class="text-center">Annunci pubblici: <?php echo count($res); ?></h2>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" class="d-inline">
                                    ...
                                    <button type="submit" class="btn btn-success btn-sm" name="sospendi">Sospendi</button>
                                </form>
                                <form method="post" class="d-inline">
                                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($articolo['id'], ENT_QUOTES, 'UTF-8'); ?>">
